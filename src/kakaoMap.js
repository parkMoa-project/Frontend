window.kakao = window.kakao || {}, window.kakao.maps = window.kakao.maps || {}, window.daum && window.daum.maps ? window.kakao.maps = window.daum.maps : (window.daum = window.daum || {}, window.daum.maps = window.kakao.maps),
  function () {
    ...
    o.VERSION = {
      ...
      ROADVIEW_CSS: "//t1.daumcdn.net/roadviewjscore/core/openapi/standard/210729/roadview.js"
    };
    ...
    var c = o.onloadcallbacks,
      ...
      S = "",
      I = {
        v3: r + "//t1.daumcdn.net/mapjsapi/js/main/4.4.1/kakao.js",
    ...
    S = _.appkey, S && (o.apikey = S), o.version = "4.4.1";
    var R = _.libraries;
